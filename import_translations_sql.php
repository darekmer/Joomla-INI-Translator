...
<head>
    ...
    <title><?php echo $uiTranslations['import_sql_translations_title']; ?></title>
...
<div class="main">
    ...
    <h2><?php echo $uiTranslations['import_sql_heading']; ?></h2>
    <form action="import_translations_sql_process.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="sqlFile" class="form-label"><?php echo $uiTranslations['select_sql_file_label']; ?></label>
            <input type="file" class="form-control" id="sqlFile" name="sqlFile" required>
        </div>
        <button type="submit" class="btn btn-primary"><?php echo $uiTranslations['import_button']; ?></button>
    </form>
			</div>
		</div>
	</main>
